...
class RUCM:
    ...
    def saveAsFile(self,outFile):
        ...
        colum0 = ["User Case Name", "Brief Description", "Precondition", "Primary Actor", "Secondary Actor", "Dependency", "Generalization"]
        ...
        sheet1.write_merge(8, 9+len(self.basic_obj.basic_steps_list), 0, 0, 'Basic Flow',self.set_style('黑体', 220, True))
        ...
        for item in self.specific_obj_list:
            ...
            sheet1.write_merge(baseLine+1, baseLine+1, 1, 2, "RFS "+str(item.specific_RFS), self.set_style('宋体', 220, True))
